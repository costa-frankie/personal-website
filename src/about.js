...
export function displayAboutContent() {
    ...
    const content = `
        ...
        <section class="full-width flex-column flex-align-center gap-md padding-vert-4xl section--surface-alt" id="values-section">
            <div class="flex-column flex-align-center gap-lg page-max-width">
                <h1 class="text-h1 full-width centered font-mono color-on-brand">My values</h1>
                <p class="text-h4 centered font-mono color-on-brand">These are a few principles that shape how I think and approach my work.</p>
                <div class="flex-row gap-xl flex-align-stretch justify-center flex-wrap" id="values-container">
                    ${displayValuesContent()}
                </div>
            </div>
        </section>
        <section class="flex-column flex-align-center gap-sm padding-horizon-md padding-vert-2xl page-max-width" id="my-story-container" >
            ...
            <div class="readable flex-column gap-lg padding-horizon-3xl padding-vert-2xl theme-nav" id="my-story-content">
                ...
                <p class="text-h5 full-width font-mono">You can connect with me on <a href="https://www.linkedin.com/in/frankie-j-costa/" target="_blank">LinkedIn</a>.</p>
